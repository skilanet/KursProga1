...
void Menu<T, arr_size>::run() {
    ...
    do {
        ...
        switch (choice) {
            ...
            case 3: print_tree(); break;
            case 4: traverse_tree(); break;
            case 5: clear_tree(); break;
            case 6: save_to_text_file(); break;
            case 7: load_from_text_file(); break;
            case 8: save_to_binary_file(); break;
            case 9: load_from_binary_file(); break;
...
void Menu<T, arr_size>::remove_element() {
    ...
    switch (sub_choice) {
        case 1: remove_by_value(); break;
        case 2: remove_by_index(); break;
